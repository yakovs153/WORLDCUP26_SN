...
function buildDigest({
  ...
  const tom = octopusEntry(matches, cfg.scoring, undefined, cfg.analystOverrides, { values: cfg.bonus, topScorers: cfg.bonusResults?.topScorers ?? (cfg.bonusResults?.topScorer ? [cfg.bonusResults.topScorer] : []) })
