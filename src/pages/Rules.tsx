  ...
  return (
    ...
    >
      ...
      <Section title="חוקים חשובים" icon="📌">
        <Bullet>ניתן לעדכן ניחוש בכל עת — עד שריקת הפתיחה של המשחק.</Bullet>
        ...
        <Bullet>שכחת לנחש? 🤖 טום האנליסט (ה-AI שלנו) ינחש עבורך אוטומטית עם פתיחת המשחק — אבל תקבל רק <strong>70%</strong> מהנקודות על ניחוש כזה. אז עדיף תמיד לנחש בעצמך!</Bullet>
