  ...
  return (
    ...
    >
      ...
      <Section title="חוקים חשובים" icon="📌">
        ...
        <Bullet>שכחת לנחש? 🤖 רובי האנליסט (ה-AI שלנו) ינחש עבורך אוטומטית עם פתיחת המשחק — אבל תקבל רק <strong>50%</strong> מהנקודות על ניחוש כזה. אז עדיף תמיד לנחש בעצמך!</Bullet>
      </Section>
