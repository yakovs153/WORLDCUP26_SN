  ...
  return (
    ...
    >
      ...
      <Section title="חוקים חשובים" icon="📌">
        ...
        <Bullet>שכחת לנחש? 🎲 עמוס ואביגדור (ה-AI שלנו) ינחשו עבורך אוטומטית עם פתיחת המשחק — אבל תקבל רק <strong>50%</strong> מהנקודות על ניחוש כזה. אז עדיף תמיד לנחש בעצמך!</Bullet>
      </Section>
